...
### Do Most Researchers Still Use Pepper or NAO?
...
There are notable exceptions. Elderly care research gravitates toward the PARO seal rather than humanoids, because the softness and non-threatening scale fits the context better. The Miroka robot appeared in a 2025 HRI paper as an alternative, and assistive robotics work by Broekens et al. used purpose-built platforms.

The conclusion we reached is that hardware availability functions as a constraint that quietly shapes what research questions even get asked. When you only have Pepper, you design studies for Pepper.

---

### Embodiment Freedom: Morphological Overview
...
What would make a robot *unsuitable* for this case: human-sized humanoids like Pepper would create proxemic tension in a small study space as they occupy the personal zone of someone sitting at a desk. Brightly coloured or highly stylised robots (like Spritebot) might work for children but would feel out of place in a study environment.
